...
class DatumNcsmVceOut(Datum):
    ...
    def _set_a_aeff_nhw_to_states_map(self):
        ...
        for k, v in a_aeff_nhw_to_states.items():
            if len(v) > 0:
    ...
    def a_aeff_to_states_map_for_nhw(self, nhw):
    ...
    def a_aeff_to_ground_state_map_for_nhw(self, nhw):
        return {k: v[0] for k, v in
                self.a_aeff_to_states_map_for_nhw(nhw).items()}

    def aeff_exact_to_states_map_for_nhw(self, nhw):
        aeff_exact_to_states = dict()
        for k, v in self.a_aeff_to_states_map_for_nhw(nhw).items():
            if k[0] != k[1]:
                continue
            else:
    ...
    def aeff_exact_to_ground_state_map_for_nhw(self, nhw):
        return {k: v[0] for k, v in
                self.aeff_exact_to_states_map_for_nhw(nhw).items()}

    def aeff_exact_to_ground_state_energy_map_for_nhw(self, nhw):
        return {k: v.E for k, v in
                self.aeff_exact_to_ground_state_map_for_nhw(nhw).items()}
    ...
    def a_aeff_to_states_map_for_nmax(self, nmax, a0):
        a_aeff_to_states = dict()
    ...
    def a_aeff_to_ground_state_map_for_nmax(self, nmax, a0):
        return {k: v[0] for k, v in
                self.a_aeff_to_states_map_for_nmax(nmax=nmax, a0=a0).items()}

    def aeff_exact_to_states_map_for_nmax(self, nmax, a0):
        aeff_exact_to_states = dict()
        for k, v in self.a_aeff_to_states_map_for_nmax(
                nmax=nmax, a0=a0
        ).items():
            if k[0] != k[1]:
                continue
    ...
    def aeff_exact_to_ground_state_map_for_nmax(self, nmax, a0):
        return {k: v[0] for k, v in
                self.aeff_exact_to_states_map_for_nmax(
                    nmax=nmax, a0=a0
                ).items()}

    def aeff_exact_to_ground_state_energy_map_for_nmax(self, nmax, a0):
        return {k: v.E for k, v in
                self.aeff_exact_to_ground_state_map_for_nmax(
                    nmax=nmax, a0=a0
                ).items()}
